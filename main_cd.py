...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_ids', type=str, default='2,4,6,7', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--project_name', default='aug.14.2023', type=str)
    ...
    # tensorboard log
    parser.add_argument('--log_dir', default='/app/tensor_logs/')
