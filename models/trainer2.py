...
class CDTrainer():
    ...
    def _collect_running_batch_states(self):
        ...
        self.writer.add_scalar('train/loss', self.G_loss.item(), self.global_step)
        self.writer.add_scalar('train/acc', running_acc, self.global_step)
    ...
    def _collect_epoch_states(self):
        ...
        self.writer.add_scalar('val/acc', self.epoch_acc, self.epoch_id)
